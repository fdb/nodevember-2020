// Nodevember day 8 - Layers
// Different layers of noise with attribute wrangle
...
grid1.setInput('columns', 30);
grid1.setInput('rows', 30);
grid1.x = 150;
grid1.y = 20;

const wrangle1 = new nodes.WrangleNode('wrangle1');
// wrangle1.setInput('expressions', 'pscale = noise($pt.x, $pt.y , 0)');
wrangle1.setInput('expressions', 'pscale = cos($pt * 0.2 + $time) * 1');
wrangle1.x = 150;
wrangle1.y = 80;
